...
function draw() {
  ...
  text("2022", width *0.43, height * 0.88);
...
fill(106, 159, 180);
  ...
  fill(255, 117, 31);    } else if (t2 > 20 && t2 < 25) {
      fill(204, 78, 0);
    } else if (t2 > 30 && t2 < 35) {
      fill(175, 78, 8);
    } else if (t2 > 35) {
...
fill(106, 159, 180);
  ...
  fill(255, 117, 31);    } else if (t3 > 20 && t3 < 25) {
      fill(204, 78, 0);
    } else if (t3 > 30 && t3 < 35) {
      fill(175, 78, 8);
    } else if (t3 > 35) {
...
fill(106, 159, 180);
  ...
  fill(255, 117, 31);    } else if (t4 > 20 && t4 < 25) {
      fill(204, 78, 0);
    } else if (t4 > 30 && t4 < 35) {
      fill(175, 78, 8);
    } else if (t4 > 35) {
...
fill(106, 159, 180);
  ...
  fill(255, 117, 31);    } else if (t5 > 20 && t5 < 25) {
      fill(204, 78, 0);
    } else if (t5 > 30 && t5 < 35) {
      fill(175, 78, 8);
    } else if (t5 > 35) {
...
fill(106, 159, 180);
  ...
  fill(255, 117, 31);    } else if (t6 > 20 && t6 < 25) {
      fill(204, 78, 0);
    } else if (t6 > 30 && t6 < 35) {
      fill(175, 78, 8);
    } else if (t6 > 35) {
...
fill(106, 159, 180);
  ...
  fill(255, 117, 31);    } else if (t7 > 20 && t7 < 25) {
      fill(204, 78, 0);
    } else if (t7 > 30 && t7 < 35) {
      fill(175, 78, 8);
    } else if (t7 > 35) {
...
fill(106, 159, 180);
  ...
  fill(255, 117, 31);    } else if (t8 > 20 && t8 < 25) {
      fill(204, 78, 0);
    } else if (t8 > 30 && t8 < 35) {
      fill(175, 78, 8);
    } else if (t8 > 35) {
...
fill(106, 159, 180);
  ...
  fill(255, 117, 31);    } else if (t9 > 20 && t9 < 25) {
      fill(204, 78, 0);
    } else if (t9 > 30 && t9 < 35) {
      fill(175, 78, 8);
    } else if (t9 > 35) {
...
fill(106, 159, 180);
  ...
  fill(255, 117, 31);    } else if (t10 > 20 && t10 < 25) {
      fill(204, 78, 0);
...
fill(106, 159, 180);
  ...
  fill(255, 117, 31);    } else if (t11 > 20 && t11 < 25) {
      fill(204, 78, 0);
...
fill(106, 159, 180);
  ...
  fill(255, 117, 31);    } else if (t12 > 20 && t12 < 25) {
      fill(204, 78, 0);
